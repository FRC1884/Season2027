...
public abstract class StateMachine<E extends Enum<E>> extends SubsystemBase {
     ...
     *
     * @param name              name of the state machine to send over network
     *                          tables
    ...
    /**
     * adds the specified system to the set of child subsystems owned by the current
     * state machine
     *
    ...
    /**
     * Enable the state machine to start running. Transitions and state commands
     * will only run while
    ...
    /**
     * Stop the state machine from running. No transitions or state commands will
     * run while the
     * machine is disabled
     */
    ...
    /**
     * @return the object that returns the current transition information. Will be
     *         null if there is no
     *         transition
     */
    ...
    /**
     * A command that will keep running until it gets to the target state, but it
     * supports
    ...
    /**
     * A command that will end immediately independent of if it reaches the target
     * state or not
     *
     * @param state   the state to go to
     * @param command the command to run upon reaching that state
    ...
    /**
     * User-implemented method to determine the state of the machine. THIS METHOD IS
     * RESPONSIBLE FOR
