...
public final class GlobalConstants {
  ...
  /**
   * Checks whether the correct robot is selected when deploying (the main method
   * is only ever
   * called on deploy).
   */
  public static void main(String... args) {
    if (ROBOT == RobotType.SIMBOT) {
      Alert realModeAlert = new Alert("SIM robot loaded in REAL mode, gains likely breaking!", AlertType.kWarning);
  ...
  public static class FieldConstants {
    ...
    public static class Hub {
      ...
      public static final double innerOpeningRadius = Math.max(0.0, (innerWidth / 2.0) - gamePieceRadius);
