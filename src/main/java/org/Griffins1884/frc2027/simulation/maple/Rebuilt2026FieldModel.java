...
/**
 * Terrain/marker helpers for the local 2026 field model used in simulation and
 * AdvantageScope.
 */
public final class Rebuilt2026FieldModel implements TerrainModel {
  private static final Rebuilt2026FieldContactModel CONTACT_MODEL = Rebuilt2026FieldContactModel.INSTANCE;
  public static final ChassisFootprint CHASSIS_FOOTPRINT = Rebuilt2026RobotProfile.DEFAULT_FOOTPRINT;
  public static final ChassisMassProperties CHASSIS_MASS_PROPERTIES = Rebuilt2026RobotProfile.DEFAULT_CHASSIS_MASS_PROPERTIES;
