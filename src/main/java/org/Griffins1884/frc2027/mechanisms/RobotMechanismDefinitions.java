...
/**
 * Repo-specific mechanism catalog for the current non-drivetrain, non-vision
 * systems.
 *
 * <p>
 * These definitions are the migration target for the old generic family classes
 * and the config
 * source for future dashboard/debug tooling.
 */
public final class RobotMechanismDefinitions {
    private static final Set<MechanismTelemetry.Signal> fullTelemetry = EnumSet.allOf(MechanismTelemetry.Signal.class);
    private static final Set<MechanismDefinition.Capability> standardCapabilities = MechanismDefinition.MechanismConfig
            .capabilities(
    ...
    public static final MechanismDefinition INTAKE = MechanismDefinition
            .builder("intake", "Intake", MechanismDefinition.MechanismType.INTAKE)
            .config(
                    mechanismConfig(
                            motorGroup(
    ...
    public static final MechanismDefinition INDEXER = MechanismDefinition
            .builder("indexer", "Indexer", MechanismDefinition.MechanismType.INDEXER)
            .config(
                    mechanismConfig(
                            motorGroup(
                                    MechanismDefinition.MotorControllerType.TALON_FX,
    ...
    public static final MechanismDefinition SHOOTER = MechanismDefinition
            .builder("shooter", "Shooter", MechanismDefinition.MechanismType.FLYWHEEL)
            .config(
                    mechanismConfig(
                            motorGroup(
                                    MechanismDefinition.MotorControllerType.TALON_FX,
    ...
    public static final MechanismDefinition INTAKE_PIVOT = MechanismDefinition.builder(
    ...
    public static final MechanismDefinition SHOOTER_PIVOT = MechanismDefinition.builder(
    ...
    public static final MechanismDefinition TURRET = MechanismDefinition
            .builder("turret", "Turret", MechanismDefinition.MechanismType.TURRET)
            .config(
                    mechanismConfig(
                            motorGroup(
    ...
    public static final MechanismDefinition TOOTH_ROLLOUT = MechanismDefinition.builder(
    ...
    public static final MechanismDefinition SPINDEXER = MechanismDefinition.builder(
    ...
    private static final List<MechanismDefinition> allDefinitions = List.of(
