...
public final class GamePieceVisionConstants {
    ...
    // 2D stuff
    static final Transform2d ROBOT_CENTER_TO_DETECTOR_LIMELIGHT_2D = new Transform2d(0, 0, Rotation2d.fromDegrees(180));
    ...
    static final Transform3d ROBOT_CENTER_TO_DETECTOR_LIMELIGHT_3D = new Transform3d(
    ...
    public static final VisionIO.CameraConstants NOTE_CAM_CONSTANTS = new VisionIO.CameraConstants(
