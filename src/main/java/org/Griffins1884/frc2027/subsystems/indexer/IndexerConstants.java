...
public final class IndexerConstants {
    ...
    public static final GlobalConstants.Gains GAINS = new GlobalConstants.Gains("Indexer/Gains", 100, 0.02, 1.0,
            0.37952, 0.017, 0.025075);
    public static final double VELOCITY_TOLERANCE = 50.0;
    public static final LoggedTunableNumber FORWARD_RPM = new LoggedTunableNumber("Indexer/ForwardRpm", 6000.0);
    public static final LoggedTunableNumber REVERSE_RPM = new LoggedTunableNumber("Indexer/ReverseRpm", -6000.0);
