...
public class Module {
  ...
  public void periodic() {
    ...
    String inputKey = "Swerve/Module" + index + "/Inputs";
    Logger.recordOutput(inputKey + "/DriveConnected", inputs.driveConnected);
    Logger.recordOutput(inputKey + "/DrivePositionRad", inputs.drivePositionRad);
    Logger.recordOutput(inputKey + "/DriveVelocityRadPerSec", inputs.driveVelocityRadPerSec);
    Logger.recordOutput(inputKey + "/DriveAppliedVolts", inputs.driveAppliedVolts);
    Logger.recordOutput(inputKey + "/DriveCurrentAmps", inputs.driveCurrentAmps);
    Logger.recordOutput(inputKey + "/TurnConnected", inputs.turnConnected);
    Logger.recordOutput(inputKey + "/TurnPosition", inputs.turnPosition);
    Logger.recordOutput(inputKey + "/TurnVelocityRadPerSec", inputs.turnVelocityRadPerSec);
    Logger.recordOutput(inputKey + "/TurnAppliedVolts", inputs.turnAppliedVolts);
    Logger.recordOutput(inputKey + "/TurnCurrentAmps", inputs.turnCurrentAmps);
